...
namespace Application.Contracts.Persistence
{
    public interface IProviderServices
    {
        ...
        //   public Task<bool> ConfirmTransactionAsync(int transactionId, string userId, bool isConfirm);
        public Task<ResultDto> ConfirmTransactionAsync(int transactionId, string userId);
